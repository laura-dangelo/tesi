...
\begin{table}
	...
	\begin{tabular}{r||cc|cc|cc}
		...
		\hline
		Proposed model  		&		0		  	    &   5.25 $\cdot 10^{-3}$ &  0	& 1.00 $\cdot 10^{-3}$	&  2.50 $\cdot 10^{-4}$	& 3.50 $\cdot 10^{-3}$	\\
		%		$L_0$   & 5.50 $\cdot 10^{-3}$	&   1.00 $\cdot 10^{-3}$ &  0	 & 3.33 $\cdot 10^{-4}$	&  0	& 8.75 $\cdot 10^{-4}$	
		$L_0$   & 2.20 $\cdot 10^{-2}$	&   2.97 $\cdot 10^{-2}$ & 1.73 $\cdot 10^{-2}$ & 2.33 $\cdot 10^{-2}$	&  2.26 $\cdot 10^{-2}$	& 2.30 $\cdot 10^{-2}$		
	\end{tabular}
...
\begin{table}
	...
	\begin{tabular}{r||cc|cc|cc}
								...
								&  $T=100$ 		  & $T=200$ 		& $T=100$ 		  & $T=200$   & $T=100$ 		  & $T=200$\\
								\hline
		Proposed model  		&		1		  &   0.915			&  0.870			  & 0.923 &  1			  & 0.846		\\
	...
	\end{tabular}
\caption[Adjusted Rand index of the estimated clusters of activity on the simulated data.]{Adjusted Rand index of the estimated clusters of activity on the simulated data for the proposed model, the two-stage approach ``$L_0$ + hierarchical'' and a hierarchical clustering on the true signal. }
\end{table}

\begin{figure}
	\centering
	\includegraphics[width=.75\linewidth]{ch4/n20_T100_err03_Rand1}\\
	\includegraphics[width=.75\linewidth]{ch4/n20_T200_err03_Rand091}
	\label{ch4:fig_n20}
...
\begin{figure}
	\centering
	\includegraphics[width=.75\linewidth]{ch4/n30_T100_err03_prior186_Rand087}\\
	\includegraphics[width=.75\linewidth]{ch4/n30_T200_seed1_err03_prior186_Rand092}
	\label{ch4:fig_n30}
...
\begin{figure}
	...
	\includegraphics[width=.75\linewidth]{ch4/n40t200}
	\label{ch4:fig_n40}
