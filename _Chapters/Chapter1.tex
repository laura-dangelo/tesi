...
\label{sec:ch1_deconvolution_methods}
...
A different approach is proposed by \citet{wei2019}: instead of focusing the relationship between the experimental conditions and some summary statistic of the resulting spike train, they study of the distribution of the deconvolved output. In particular, this allows to analyze quantities such as the spike probability and the spikes' amplitudes. They propose a mixture model, with a Dirac mass at zero, representing the absence of neuronal response, and a translated Gamma distribution to model the positive amplitudes.
...
\begin{figure}
	\centering
	\includegraphics[width=.9\textwidth]{neuron2_trace}
	\centering
	\includegraphics[width=.9\textwidth]{neuron1_trace}
