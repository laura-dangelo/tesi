...
\begin{figure}
	\centering
	\includegraphics[width = .7\textwidth]{_Images/ch3_hist1.pdf}\\
	%
	\includegraphics[width = .7\textwidth]{_Images/ch3_hist2.pdf}\\
	%
	\includegraphics[width = .7\textwidth]{_Images/ch3_hist3.pdf}
